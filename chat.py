...
def LoadChatData(tid):
	...
	if not os.path.isfile(tfile):
		tjson = {"chat": [ {"title": "Hello", "type": "message", "id": 1, "from": "Andrew", "to": "Andrew", "message": "This is a test message", "date": "04-27-2023", "location": "Prince George"} ]}
...
def WriteOut():
	...
	tval = '{"chat": [{"title": "Epinephrine", "to": "Everyone", "date": "19-05-2023", "message": "Epi IM should be first medication on list rather than near the end\u00a0", "type": "physician", "by": "Spooner"}, {"title": "Med Prioritization", "to": "Everyone", "date": "19-05-2023", "message": "Is there a way to communicate prioritzation of medications.\u00a0 Eg. epi first, benadryl second, etc.\u00a0\u00a0", "type": "physician", "by": "Spooner"}]}'

	f = open('allergy.chat.json', "w")
	f.write(tval)
	f.close()
